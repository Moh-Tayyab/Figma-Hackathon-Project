  ...
  const onRemove = (product:any) => {
    ...
    return (
        <CartContext.Provider 
               value={{index, setIndex, quantity, setQuantity, incQty, decQty, cartItems, setCartItems, addProduct, totalQuantity, setTotalQuantity, totalPrice, setTotalPrice, onRemove, toggleCartItemQty}}
    >
        <div> {children} </div>
        </CartContext.Provider>
    )
